...
internal sealed class EventInfoComponent: IDisposable
{
    ...
    [
        new EventQuest("7.3 版本限时幻想药", [new UnlockLinkId(568)], AtBeijingTwoPm(new DateOnly(2025, 12, 16))),
        new EventQuest("金碟嘉年华", [new QuestId(5322)], AtBeijingTwoPm(new DateOnly(2025, 11, 27)))
    ];
